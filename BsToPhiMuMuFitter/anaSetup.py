...
dataFilePath = "/afs/cern.ch/work/p/pkalbhor/public/Modified_sel_BsToPhiMuMu_2016_Rereco07Aug17_Presel_data_cut_bdt_s0.root"
UnfilteredMC = "/afs/cern.ch/work/p/pkalbhor/public/Modified_sel_BsToPhiMuMu_NofilterMC_signal_2016_mc.lite_nocut.root"
sigMC = "/afs/cern.ch/work/p/pkalbhor/public/Modified_sel_BsToPhiMuMu_2016MC_combined_Presel_mc.lite_cut_bdt.root"
# sigMC = "/afs/cern.ch/work/p/pkalbhor/BFitter/BPhysicsData/data_v6/sel_BsToPhiMuMu_OfficialMC_signal_2016_phimm_Jpsi_Psi_Presel_mc.lite_cut_bdt.root" #Removing Rigger cuts
